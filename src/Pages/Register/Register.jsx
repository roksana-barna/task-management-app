      ...
      .then(result => {
        ...
        updateUserProfile(data.name, data.photoURL)
          .then(() => {
            ...
            fetch('https://task-management-server-iif6gv4cm-roksana-barna.vercel.app/users', {
              method: 'POST',
              headers: {
        ...
        <div className="hero-content  flex-col  lg:flex-row-reverse">
          ...
          <div className="card flex-shrink-0 w-full max-w-lg shadow-2xl bg-base-100">
            <form className="card-body bg-base-200 " onSubmit={handleSubmit(onSubmit)} >
              ...
              <input className="btn bg-cyan-400 text-white" type="submit" value="Register" />
              </div>
            </form>
            <SocialLogin></SocialLogin>
            <div className='flex gap-2 mt-3 justify-center'>
              <p className='mb-6'><small className='text-blue-900 pl-8  mt-4'>Already have an account?? <button className='bg-cyan-400 text-white px-4 py-1 '><Link to="/login">Login</Link></button></small></p>
